...
const TabBar = () => {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-20 mx-auto mb-4 flex h-12 px-6 sm:h-14">
      <div className="relative mx-auto flex h-full items-center rounded-xl border border-neutral-400/20 bg-white/40 backdrop-blur-md dark:border-neutral-600/30 dark:bg-black/40 dark:text-white">
        <span
