...
const TabBar = () => {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-20 mx-auto mb-4 h-12 w-full max-w-xl px-6 sm:h-16">
      <div className="relative mx-auto flex h-full w-full items-center rounded-md border border-neutral-400/20 bg-white/40 backdrop-blur-md dark:border-neutral-600/30 dark:bg-black/40 dark:text-white">
        <span
