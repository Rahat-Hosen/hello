...
I recently see this effect on the [Base Hub](https://basehub.ai/) website and I wanted to recreate it.
...
I will provide a solution with Tailwind CSS and React, and one React and CSS. I will also explore more UI effects with this.
...
The spotlight effect is created by applying a radial-gradient mask to the overlay input's border. The gradient mask has a transparent outer region, creating a spotlight-like appearance. The component uses event listeners to handle mouse movement, focus, and blur events.
...
I never saw this effect before and I think it's a really cool way to make a form (or anything else) more interactive. Let me know what you think!
