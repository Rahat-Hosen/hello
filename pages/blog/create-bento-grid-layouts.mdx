...
<div className="columns-1 gap-4 md:columns-3">
  ...
  <div className="mb-4 h-40 break-inside-avoid rounded-xl border-2 border-slate-400/10 bg-neutral-100 p-4 dark:bg-neutral-900"></div>
  <div className="mb-4 h-32 break-inside-avoid rounded-xl border-2 border-slate-400/10 bg-neutral-100 p-4 dark:bg-neutral-900"></div>
  <div className="mb-4 h-32 break-inside-avoid rounded-xl border-2 border-slate-400/10 bg-neutral-100 p-4 dark:bg-neutral-900"></div>
  <div className="mb-4 h-32 break-inside-avoid rounded-xl border-2 border-slate-400/10 bg-neutral-100 p-4 dark:bg-neutral-900"></div>
...
```jsx
<div className="columns-1 gap-4 md:columns-3">
  {[24, 32, 40, 32, 32, 32, 16, 16, 64].map((height, index) => (
    <div
      key={index}
