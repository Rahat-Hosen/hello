  ...
  return (
    <div>
      ...
      <div className="prose mt-24 dark:prose-dark prose-ul:pl-0">
        ...
        <p>
          Below is a showcase of various projects I've worked on over the years.
          These include both client work and personal projects. Please note that
          while I'm proud of all these projects, some of them are no longer
          actively maintained. Feel free to click on any project to expand and
          learn more about it.
        </p>
        <ul className="items flex max-w-xs list-none flex-col justify-between divide-y">
          <li className="m-0 mt-0 py-2 pl-0">
            <AccordionProject
              title="basyl"
              date={2023}
          ...
          <li className="m-0 py-2 pl-0">
            <AccordionProject
              title="lafourche"
              date={`2020-21`}
              description="Best online shop to buy organic food in France. Leading the front-end development, from Shopify to Next.js. Front-end architecture & implementation of the new branding"
              links={[
                {
                  text: "Website",
